...
### UPDATE : 05/02/2026 This has now replaced the old Microsoft Exchange Toolbox V1 - https://github.com/reprodev/Exchange-ToolboxV1

A menu-based toolbox built in Powershell to efficiently perform Admin Tasks for Mailboxes and Calendars for Service Desk Analysts and Deskside Engineers in Microsoft Exchange. Now with MFA Support
